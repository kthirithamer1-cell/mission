...
public class ReservationController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable("id") Long id, @RequestBody ReservationDTO dto) {
        try {
    ...
    public ResponseEntity<?> updateStatut(@PathVariable("id") Long id, @RequestBody Map<String, String> body) {
        try {
